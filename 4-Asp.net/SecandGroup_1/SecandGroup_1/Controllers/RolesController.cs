...
namespace SecandGroup_1.Controllers
{
    public class RolesController : Controller
    {
        ...
        public IActionResult AssignPermissions(int Id) 
        {
         ...
         ViewBag.RolePremission = role.Permissions.Select(p=>p.Id).ToList();
        ...
        public IActionResult AssignPermissions(int Id,List<int> permissionIds)
        {
            ...
            IEnumerable<Permission> selectedPermissions = _context.Permissions.Where(p => permissionIds.Contains(p.Id));
